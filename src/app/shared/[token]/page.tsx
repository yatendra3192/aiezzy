...
export default function SharedTripPage() {
  ...
  useEffect(() => {
    fetch(`/api/shared/${token}`)
      ...
      .catch(() => setError('This shared trip link is invalid or has been removed.'))
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center space-y-3">
          ...
          <p className="text-text-secondary text-sm font-body">Loading shared trip...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center space-y-4">
          ...
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
            ...
            className="mt-4 bg-accent-cyan text-white font-display font-bold text-sm px-6 py-3 rounded-xl">
            Plan Your Own Trip
          </motion.button>
        </div>
      </div>
